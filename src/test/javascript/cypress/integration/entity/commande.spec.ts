...
describe('Commande e2e test', () => {
  ...
  const commandeSample = { id: '87c4458c-045e-49bd-ba1a-e7f981ce4867' };
  ...
  describe('new Commande page', () => {
    ...
    it('should create an instance of Commande', () => {
      cy.get(`[data-cy="id"]`).type('2fad6c8c-3176-4db0-927b-72f12c77ef20').should('have.value', '2fad6c8c-3176-4db0-927b-72f12c77ef20');

...
import com.coopcycle.breton.service.mapper.CommandeMapper;
...
public class CommandeService {
    ...
    public Mono<CommandeDTO> update(CommandeDTO commandeDTO) {
        log.debug("Request to save Commande : {}", commandeDTO);
        return commandeRepository.save(commandeMapper.toEntity(commandeDTO).setIsPersisted()).map(commandeMapper::toDto);
    }
     ...
     */
    @Transactional(readOnly = true)
    public Mono<CommandeDTO> findOne(String id) {

...
import com.coopcycle.breton.service.LivreurService;
...
/**
 * REST controller for managing {@link com.coopcycle.breton.domain.Livreur}.
 */
@RestController
@RequestMapping("/api")
public class LivreurResource {
    ...
    public Mono<ResponseEntity<LivreurDTO>> getLivreur(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteLivreur(@PathVariable String id) {

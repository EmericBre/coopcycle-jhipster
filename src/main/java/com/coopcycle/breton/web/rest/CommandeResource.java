...
import com.coopcycle.breton.repository.CommandeRepository;
import com.coopcycle.breton.service.CommandeService;
...
/**
 * REST controller for managing {@link com.coopcycle.breton.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
public class CommandeResource {
    ...
    public Mono<ResponseEntity<CommandeDTO>> getCommande(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteCommande(@PathVariable String id) {

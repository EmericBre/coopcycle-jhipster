...
/**
 * REST controller for managing {@link com.coopcycle.breton.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
public class ProduitResource {
    ...
    public Mono<List<ProduitDTO>> getAllProduits(
        ...
        if ("paiement-is-null".equals(filter)) {
            log.debug("REST request to get all Produits where paiement is null");
            return produitService.findAllWherePaiementIsNull().collectList();
        }
    ...
    public Mono<ResponseEntity<ProduitDTO>> getProduit(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteProduit(@PathVariable String id) {
